...
<nav class="position-fixed nav nav1 nav2 flex-column top-0 start-0 p-0 m-0 bg-danger" onmouseenter="navExp()" onmouseleave="navCol()" style="height:100vh; overflow-y:hidden;">
    ...
    <a class="nav-link nav-link1 link2 active"  aria-current="page" href="./">
    ...
    <?php if($role=='user'){ ?>
        <a class="nav-link nav-link1 link2" href="view.php">
            ...
            <span class="dashtext dashtext2">View Labs</span>
        </a>
        <a class="nav-link nav-link1 link2" href="equ.php">
            ...
            <span class="dashtext dashtext2">View Equipment</span>
        </a>
    <?php $role = 'user';
        ...
        <a class="nav-link nav-link1 link2" href="lent.php">
            ...
            <span class="dashtext dashtext2">Lent Equipment</span>
        </a>
        <a class="nav-link nav-link1 link2" href="upload.php">
            ...
            <span class="dashtext dashtext2">Upload Excel File</span>
        </a>
    <?php $role = 'Lab Assistant';
    } else { if($short=='Master Admin'){?>
        <a class="nav-link nav-link1 link2" href="admin.php">
            ...
            <span class="dashtext dashtext2">Manage Admin.</span>
        </a>
        <a class="nav-link nav-link1 link2" href="assist.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
            </svg>
            <span class="dashtext dashtext2">Manage Lab Asst.</span>
        </a>
        <a class="nav-link nav-link1 link2" href="lab.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-hospital" viewBox="0 0 16 16">
                <path d="M8.5 5.034v1.1l.953-.55.5.867L9 7l.953.55-.5.866-.953-.55v1.1h-1v-1.1l-.953.55-.5-.866L7 7l-.953-.55.5-.866.953.55v-1.1h1ZM13.25 9a.25.25 0 0 0-.25.25v.5c0 .138.112.25.25.25h.5a.25.25 0 0 0 .25-.25v-.5a.25.25 0 0 0-.25-.25h-.5ZM13 11.25a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5Zm.25 1.75a.25.25 0 0 0-.25.25v.5c0 .138.112.25.25.25h.5a.25.25 0 0 0 .25-.25v-.5a.25.25 0 0 0-.25-.25h-.5Zm-11-4a.25.25 0 0 0-.25.25v.5c0 .138.112.25.25.25h.5A.25.25 0 0 0 3 9.75v-.5A.25.25 0 0 0 2.75 9h-.5Zm0 2a.25.25 0 0 0-.25.25v.5c0 .138.112.25.25.25h.5a.25.25 0 0 0 .25-.25v-.5a.25.25 0 0 0-.25-.25h-.5ZM2 13.25a.25.25 0 0 1 .25-.25h.5a.25.25 0 0 1 .25.25v.5a.25.25 0 0 1-.25.25h-.5a.25.25 0 0 1-.25-.25v-.5Z"/>
                <path d="M5 1a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v1a1 1 0 0 1 1 1v4h3a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h3V3a1 1 0 0 1 1-1V1Zm2 14h2v-3H7v3Zm3 0h1V3H5v12h1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3Zm0-14H6v1h4V1Zm2 7v7h3V8h-3Zm-8 7V8H1v7h3Z"/>
            </svg>
            <span class="dashtext dashtext2">Manage Labs</span>
        </a>
    <?php $role = 'Admin';
    } else{?>
     <a class="nav-link nav-link1 link2" href="assist.php">
