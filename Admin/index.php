...
<body>
    <div class="dash_admin_box">
        ...
        <button class="btn btn-primary btn-block" onclick="window.location.href='assist.php'"> 
            Manage Lab Assistants
        </button>
        <br><br>
        <button class="btn btn-primary btn-block" onclick="window.location.href='lab.php'">
            Manage Labs
        </button>
        <br><br>
